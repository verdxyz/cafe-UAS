...
<head>
    ...
    <title>Login - Little Latte Cafe</title>
...
<body class="bg-[#efeee6] text-[#252525] antialiased selection:bg-[#252525] selection:text-[#efeee6] font-light min-h-screen flex flex-col">
    ...
    <header class="flex items-center justify-between py-8 px-5 sm:px-8 lg:px-14 w-full max-w-[112rem] mx-auto">
        ...
        <a href="/register" class="font-light uppercase tracking-tight text-sm hover:opacity-60 transition-opacity border-b border-[#252525]/20 pb-1">Create Account</a>
    </header>
    ...
    <main class="flex-grow flex items-center justify-center px-5 py-12">
        <div class="w-full max-w-md">
            ...
            <div class="mb-12 text-center">
                ...
                <h1 class="text-4xl lg:text-5xl font-light uppercase tracking-tight leading-none mb-4">Welcome<br>Back</h1>
                <p class="text-[#252525]/70 text-sm font-light uppercase tracking-tight">Enter your credentials to continue.</p>
            </div>
            ...
            <form id="loginForm" class="flex flex-col gap-8">
                <!-- Email Input -->
                ...
                <!-- Password Input -->
                <div class="flex flex-col gap-2">
                    <label for="password" class="text-xs font-light uppercase tracking-tight text-[#252525]/70">Password</label>
    ...
    <script>
        ...
        document.getElementById('loginForm').addEventListener('submit', async (e) => {
            ...
            try {
                ...
                submitBtn.innerHTML = '<span>Sign In</span><i data-lucide="arrow-right" class="size-4" stroke-width="1.5"></i>';
                lucide.createIcons();
            }
        });
    </script>
